...
public class FragmentHistoricalResult extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        scrollView = (ScrollView) view.findViewById(R.id.scroll_historical);
    ...
    private void drawFooter(){
        ...
        imgBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AuxiliarData.getSingletonInstance().setConsultId(consult.getId());
                ...
                fcrc.setTargetFragment(FragmentHistoricalResult.this, 0);
